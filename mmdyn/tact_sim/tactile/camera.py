...
class Camera:
    ...
    def __init__(self, width, height, camera_up_vector=(0, 1, 0)):
        """
        Args:
            width (int)                 : Image width.
            height (int)                : Image height.
            camera_up_vector (list)     : Camera up vector.
        """
        self._width = width
        self._height = height
        self._view_mat = None
        ...
        self._camera_up_vec = np.array(camera_up_vector)
        self._init_camera_up_vec = np.array(camera_up_vector)
    ...
    @property
    def init_camera_up_vector(self):
        return np.array(self._init_camera_up_vec)
